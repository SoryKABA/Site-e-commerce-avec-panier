...
@section('title', 'Administration des produits')
...
@section('content')
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-md-6">
                <h5 class="fw-bold mb-0">Liste des produits</h5>
            </div>
            <div class="col-md-6">
                <div class="d-flex justitfy-content-end">
                    <a href="{{route('admin.product.create')}}" class="btn btn-primary btn-sm me-3"><i class="fas fa-folder-plus"></i>Nouveau</a>
