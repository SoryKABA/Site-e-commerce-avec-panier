...
<head>
    ...
    <link href="{{asset('css/shop_style.css')}}" rel="stylesheet" />
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="{{route('shop.home')}}">Shopping</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <button class="btn btn-outline-dark" type="submit">
                        <a href="{{route('my-cart')}}" class="text-decoration-none" style="color: inherit;">
